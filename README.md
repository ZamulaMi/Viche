...
знаходять одне одного, медіа йде P2P (DTLS/SRTP), чат — через DataConnection.
Перший клієнт у пулі тримає чергу («лобі»), за потреби відбувається
автоматичне підвищення. Якщо брокер недоступний — м'який фолбек на
офлайн-демо з симульованим співрозмовником:
